    ...
    return (
        <section className="relative isolate w-full overflow-hidden px-6 py-20" id="docs">
            ...
            <div
                ...
                style={{
                    background:
                        "radial-gradient(at center, rgba(115,138,219,0.22), rgba(115,138,219,0.1), transparent 70%)",
                }}
            />
                ...
                {helpers.map((h) => (
                    <div
                        ...
                        className={`group flex items-center justify-between rounded-xl border border-white/10 bg-white/5
                             px-4 py-3 transition hover:border-blurple/30 hover:bg-white/10 backdrop-blur-3xl
